...
public class ListProductosEntrantesFrame extends javax.swing.JFrame {
    ...
    private ProductoEntrante getEntradaSeleccionada() {
    ...
    private void initComponents() {
        ...
        detalle = new com.nicolas.hostal.vista.inventario.DetalleEntradaProductoPanel();
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        detalle.saveData();
        ProductoEntrante p_entrante = detalle.getEntrante();
    ...
    private void editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarActionPerformed
        ProductoEntrante p_entrante = getEntradaSeleccionada();
    ...
    private com.nicolas.hostal.vista.inventario.DetalleEntradaProductoPanel detalle;
